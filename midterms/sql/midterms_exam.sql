...
INSERT INTO `projects` (`project_id`, `project_name`, `technologies_used`, `web_dev_id`, `date_started`, `date_finished`) VALUES
(1, 'Facebooky', 'PHP', 1, '2024-11-02', NULL);
...
INSERT INTO `users` (`user_id`, `username`, `password`, `first_name`, `last_name`, `date_of_birth`, `date_account_created`) VALUES
(1, 'ris', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'Gabriel Christian', 'Arcega', '2001-12-13', '2024-11-02 10:22:49');
...
--
-- Dumping data for table `web_devs`
--

INSERT INTO `web_devs` (`web_dev_id`, `user_id`, `specialization`, `hire_date`) VALUES
(1, 1, 'Backend Developer', '2024-11-02');
